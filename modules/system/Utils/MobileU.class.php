...
class MobileU {
    ...
    public static function mobile_device_detect($iphone = true, $android = true, $opera = true, $blackberry = true, $palm = true, $windows = true, $mobileredirect = false, $desktopredirect = false) {
        $mobile_browser = false; // set mobile browser as false till we can prove otherwise
        $user_agent = strtolower($_SERVER['HTTP_USER_AGENT']); // get the user agent value - this should be cleaned to ensure no nefarious input gets executed
        $accept = strtolower($_SERVER['HTTP_ACCEPT']); // get the content accept value - this should be cleaned to ensure no nefarious input gets executed
